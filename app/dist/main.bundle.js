...
CoreModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
        imports: [
            ...
            __WEBPACK_IMPORTED_MODULE_11_ngx_bootstrap__["g" /* TooltipModule */].forRoot(),
            __WEBPACK_IMPORTED_MODULE_11_ngx_bootstrap__["b" /* BsDropdownModule */].forRoot(),
            __WEBPACK_IMPORTED_MODULE_11_ngx_bootstrap__["e" /* ProgressbarModule */].forRoot(),
            __WEBPACK_IMPORTED_MODULE_11_ngx_bootstrap__["a" /* AlertModule */].forRoot(),
            __WEBPACK_IMPORTED_MODULE_11_ngx_bootstrap__["f" /* TabsModule */].forRoot(),
...
var AuthService = (function () {
    function AuthService(router, http, afAuth) {
        this.router = router;
        this.http = http;
        this.afAuth = afAuth;
    ...
    AuthService.prototype.login = function (user, password) {
        ...
        this.http
            .post('/api/auth/login', { user_email: user, user_password: password }
        // { headers: headers }
        )
            .map(function (data) {
...
HeaderModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_2__angular_core__["NgModule"])({
        imports: [
            ...
            __WEBPACK_IMPORTED_MODULE_17_ngx_bootstrap__["b" /* BsDropdownModule */],
