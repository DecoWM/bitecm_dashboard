...
var ErrorInterceptor = (function () {
    function ErrorInterceptor(inj, router, notificationService) {
        this.inj = inj;
        this.router = router;
        ...
        return next
            ...
            if (error instanceof __WEBPACK_IMPORTED_MODULE_2__angular_common_http__["d" /* HttpErrorResponse */]) {
                ...
                if (error.error.message === 'Token has expired') {
                    ...
                    _this.router.navigate(['/error', error.status]);
                }
                return __WEBPACK_IMPORTED_MODULE_4_rxjs_Rx__["Observable"].throw(error);
            }
        });
    };
    ErrorInterceptor.prototype.mensajeTerminoSesion = function () {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__guards_module_import_guard__ = __webpack_require__("../../../../../src/app/core/guards/module-import-guard.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__shared_voice_control_voice_recognition_service__ = __webpack_require__("../../../../../src/app/shared/voice-control/voice-recognition.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11_ngx_bootstrap__ = __webpack_require__("../../../../ngx-bootstrap/index.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12_ng_socket_io__ = __webpack_require__("../../../../ng-socket-io/dist/index.js");
...
var CoreModule = (function () {
    function CoreModule(parentModule) {
        Object(__WEBPACK_IMPORTED_MODULE_9__guards_module_import_guard__["a" /* throwIfAlreadyLoaded */])(parentModule, 'CoreModule');
    }
    return CoreModule;
}());
CoreModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
        imports: [
            ...
            __WEBPACK_IMPORTED_MODULE_11_ngx_bootstrap__["i" /* TooltipModule */].forRoot(),
            __WEBPACK_IMPORTED_MODULE_11_ngx_bootstrap__["c" /* BsDropdownModule */].forRoot(),
            __WEBPACK_IMPORTED_MODULE_11_ngx_bootstrap__["g" /* ProgressbarModule */].forRoot(),
            __WEBPACK_IMPORTED_MODULE_11_ngx_bootstrap__["b" /* AlertModule */].forRoot(),
            __WEBPACK_IMPORTED_MODULE_11_ngx_bootstrap__["h" /* TabsModule */].forRoot(),
            __WEBPACK_IMPORTED_MODULE_12_ng_socket_io__["SocketIoModule"].forRoot({ url: 'https://notificacion.bitel.com.pe:8000', options: {} }),
        ],
        declarations: [],
        providers: [
            ...
            __WEBPACK_IMPORTED_MODULE_10__shared_voice_control_voice_recognition_service__["a" /* VoiceRecognitionService */],
...
var AuthService = (function () {
    ...
    AuthService.prototype.refresh_Token = function (token) {
        this._token = token;
    };
    // servicio que obtiene el nuevo token y lo pasa al proceso
    // de validacion del token activo
    AuthService.prototype.refreshToken = function () {
        var datos = new __WEBPACK_IMPORTED_MODULE_3_rxjs_Rx__["Subject"]();
...
var RouteBreadcrumbsComponent = (function () {
    ...
    RouteBreadcrumbsComponent.prototype.prevBreadcrumb = function () {
        //parent.history.back();
