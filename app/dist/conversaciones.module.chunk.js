webpackJsonp(["conversaciones.module"],{

/***/ "../../../../../src/app/+conversaciones/+atencion-pendiente/atencion-pendiente.component.html":
/***/ (function(module, exports) {

module.exports = "<div id=\"content\">\n  <div class=\"row\">\n    <sa-big-breadcrumbs [items]=\"[' Atención Pendiente']\" icon=\"clock-o\"\n      class=\"col-xs-10 col-sm-7 col-md-7 col-lg-4\"></sa-big-breadcrumbs>\n  </div>  \n  <sa-widgets-grid>\n    <div class=\"row\">\n      <article class=\"col-sm-12\">\n        <sa-widget color=\"darken\">\n          <div>\n            <div class=\"widget-body no-padding\">\n              <sa-datatable [options]=\"options\" [dtTrigger]=\"dtTrigger\" \n                [paginationLength]=\"true\" tableClass=\"table table-striped table-bordered table-hover\">\n                <thead>\n                  <tr>\n                    <th>\n                      <i class=\"fa fa-fw fa-user text-muted hidden-md hidden-sm hidden-xs\"></i>\n                      Cliente\n                    </th>\n                    <th [style.width]=\"'25%'\" data-hide=\"mobile-p\">\n                      <i class=\"fa fa-fw fa-clock-o text-muted hidden-md hidden-sm hidden-xs\"></i>\n                      Solicitada\n                    </th>\n                    <th [style.width]=\"'16%'\" data-hide=\"mobile-p\">\n                      <i class=\"fa fa-fw fa-clock-o text-muted hidden-md hidden-sm hidden-xs\"></i>\n                      Esperando\n                    </th>\n                    <th [style.width]=\"'2%'\" data-hide=\"mobile-p\">Chat</th>\n                  </tr>\n                </thead>                  \n                <tbody *ngIf=\"itemsObs | async as items; else loading\">\n                  <ng-container *ngFor=\"let item of items; let last = last\"\n                    sa-cond-trigger [cond]=\"last ? true : false\" [trigger]=\"dtTrigger\">\n                    <tr>\n                      <td>{{ item.cliente.nombre }}</td>\n                      <td [attr.data-order]=\"item.solicitada | moment:'x'\">{{ item.solicitada | date:\"dd-MM-yy HH:mm:ss a\" }}</td>\n                      <td>{{ item.solicitada | moment:'x' }}</td>\n                      <td class=\"text-center\">\n                        <a (click)=\"Chat(item)\">\n                          <i class=\"fa fa-lg fa-fw fa-wechat\"></i>\n                        </a>\n                      </td>\n                    </tr>\n                    <sa-dt-detalle [data]=\"item\" [type]=\"dcomp\" [trigger]=\"item._id\" [cols]=\"4\"></sa-dt-detalle>\n                  </ng-container>\n                </tbody>\n                <ng-template #loading>\n                  <tr class=\"odd\">\n                    <td valign=\"top\" colspan=\"4\" class=\"dataTables_empty\">\n                      Cargando datos...\n                    </td>\n                  </tr>\n                </ng-template>\n              </sa-datatable>\n            </div>\n          </div>\n        </sa-widget>  \n      </article>\n    </div>\n  </sa-widgets-grid>\n</div>"

/***/ }),

/***/ "../../../../../src/app/+conversaciones/+atencion-pendiente/atencion-pendiente.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return AtencionPendienteComponent; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__shared_conversaciones_service__ = __webpack_require__("../../../../../src/app/+conversaciones/shared/conversaciones.service.ts");
...
var AtencionPendienteComponent = (function () {
    function AtencionPendienteComponent(router, convService) {
        this.router = router;
    ...
    AtencionPendienteComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.convService.getPendientes()
            .subscribe(function (data) {
            console.log('data: ', data);
            _this.itemsObs.next(data.result);
        });
    };
    AtencionPendienteComponent.prototype.Chat = function (data) {
        this.router.navigate(['/conversaciones/chat', data._id]);
    };
    return AtencionPendienteComponent;
}());
AtencionPendienteComponent = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
        selector: 'atencion-pendiente',
        template: __webpack_require__("../../../../../src/app/+conversaciones/+atencion-pendiente/atencion-pendiente.component.html"),
        styles: []
    }),
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__angular_router__["c" /* Router */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__angular_router__["c" /* Router */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_5__shared_conversaciones_service__["a" /* ConversacionesService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_5__shared_conversaciones_service__["a" /* ConversacionesService */]) === "function" && _b || Object])
], AtencionPendienteComponent);

var _a, _b;
//# sourceMappingURL=atencion-pendiente.component.js.map

/***/ }),

/***/ "../../../../../src/app/+conversaciones/+chat/chat.component.css":
...
// module
exports.push([module.i, "#chat-body ul {\n  margin-bottom: 15px;\n}\n.chat-body {\n  height: 400px;\n}\n.no-pad,.page-chat {\n  padding: 0;\n}\n.btn-primary {\n  background: #3276b1 !important;\n  border-color: #2c699d !important;\n}", ""]);
...
/***/ "../../../../../src/app/+conversaciones/+chat/chat.component.html":
/***/ (function(module, exports) {

module.exports = "<div id=\"content\">\n  <div class=\"row\">\n    <sa-big-breadcrumbs [items]=\"[' Atención al cliente']\" icon=\"wechat\"\n      class=\"col-xs-6 col-sm-5 col-md-7 col-lg-4\"></sa-big-breadcrumbs>\n    <div class=\"col-xs-6 col-sm-4 col-sm-offset-3 col-md-2 col-md-offset-3 col-lg-2 col-lg-offset-6\">\n      <ng-container *ngIf=\"estado\">\n        <a *ngIf=\"estado==1\" (click)=\"atender()\" class=\"btn btn-primary btn-lg pull-right\">Atender Cliente</a>\n        <h5 *ngIf=\"estado==2\" class=\"text-center btn-success padding-10\">Atención Activa</h5>\n        <h5 *ngIf=\"estado==3\" class=\"text-center btn-danger padding-10\">Atención Finalizada</h5>\n      </ng-container>\n    </div>\n  </div>  \n  <sa-widgets-grid>\n    <div class=\"row\">\n      <article class=\"col-sm-12\">\n        <sa-widget color=\"darken\">\n          <header>\n            <span class=\"widget-icon\"> <i class=\"fa fa-wechat\"></i> </span>\n            <h2 *ngIf=\"conversacion.cliente\">Cliente: {{ conversacion.cliente.nombre }}</h2>\n            <h2 *ngIf=\"conversacion.operador\" class=\"text-right\">| Operador: {{ conversacion.operador.nombre }}</h2>\n            <h2 *ngIf=\"conversacion._id\" class=\"text-right\">| Atención: {{ conversacion._id }}</h2>\n          </header>\n          <div class=\"no-pad\">\n          <!--div class=\"widget-body no-padding\"-->\n            <div  class=\"page-chat\">\n              <div id=\"app-mensajes\" class=\"app-mensajes\">\n                <!-- <div class=\"text\" *ngFor=\"let chat of convService.chats | async\" [ngClass]=\"{'text-right':convService.usuario.id == chat.id}\">\n                  <p>{{ chat.message }}\n                    <span class=\"date\">{{chat.created | amDateFormat:'hh:mmA'}}</span>\n                  </p>\n                </div> -->\n                <div #scrollMe id=\"chat-body\" class=\"chat-body custom-scroll\">\n                  <ul>\n                    <li class=\"message\" *ngFor=\"let m of messages; let last = last\" sa-cond-trigger [cond]=\"last ? true : false\" [trigger]=\"scrollTrigger\">\n                      <img *ngIf=\"usuario.id != m.user_id\" class=\"message-picture online\" src=\"https://smartadmin-ng2.github.io/assets/img/avatars/5.png\">\n                      <img *ngIf=\"usuario.id == m.user_id\" class=\"message-picture online\" src=\"https://smartadmin-ng2.github.io/assets/img/avatars/sunny.png\" alt=\"\">\n                      <div class=\"message-text\">\n                        <time>\n                            {{m.created | amDateFormat:'hh:mmA'}}\n                        </time>\n                        <a  *ngIf=\"usuario.id != m.user_id\" class=\"username\">{{ conversacion.cliente.nombre }}</a>\n                        <a *ngIf=\"usuario.id == m.user_id\" class=\"username\">{{ usuario.nombre }}</a>\n                        <div>{{ m.message }}</div>\n                      </div>\n                    </li>\n                  </ul>\n                </div>\n              </div>\n              <!-- <hr> -->\n              \n              <!-- <input [disabled]=\"estado!=2\" name=\"mensaje\" placeholder=\"Mensaje....\" [(ngModel)]=\"message\"\n                (keyup.enter) = \"convService.setMessage(message); message='';\" class=\"form-control\" style=\"height: 77px; width: 100%; margin-bottom: 10px;\">\n              <button [disabled]=\"estado!=2\" type=\"button\" class=\"btn btn-success\" (click)=\"convService.setMessage(message); message='';\">Enviar</button> -->\n              <div class=\"chat-footer\">\n                  <div class=\"textarea-div\">\n                    <div class=\"typearea\">\n                      <textarea [disabled]=\"estado!=2\" placeholder=\"Mensaje....\" id=\"textarea-expand\" (keyup.enter)=\"sendMessageEnter()\"\n                                class=\"custom-scroll\" [(ngModel)]=\"message\" name=\"mensaje\"></textarea>\n                    </div>\n                  </div>\n                \n                  <span class=\"textarea-controls\">\n                      <button class=\"btn btn-sm btn-primary pull-right\" \n                          (click)=\"btnEnviar()\" [disabled]=\"estado!=2\">Enviar</button>\n                    <span class=\"pull-right smart-form\" style=\"margin-top: 3px; margin-right: 10px;\"> <label\n                    class=\"checkbox pull-right\">\n                      <input type=\"checkbox\" [(ngModel)]=\"enterToSend\" name=\"subscription\" id=\"subscription\"><i></i>Presione <strong> ENTER </strong> para enviar </label> </span> <a\n                    (click)=\"(null)\" class=\"pull-left\"><i class=\"fa fa-camera fa-fw fa-lg\"></i></a> </span>\n                </div>\n            </div>\n          </div>\n        </sa-widget>\n      </article>\n    </div>\n  </sa-widgets-grid>\n</div>\n"

/***/ }),

/***/ "../../../../../src/app/+conversaciones/+chat/chat.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/@angular/core.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_router__ = __webpack_require__("../../../router/@angular/router.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__shared_conversaciones_service__ = __webpack_require__("../../../../../src/app/+conversaciones/shared/conversaciones.service.ts");
...
var ChatComponent = (function () {
    function ChatComponent(route, convService, el, blockui) {
        this.route = route;
        this.convService = convService;
        this.el = el;
        this.blockui = blockui;
        this.scrollTrigger = new __WEBPACK_IMPORTED_MODULE_3_rxjs_Rx__["Subject"]();
        this.blockContent = new __WEBPACK_IMPORTED_MODULE_3_rxjs_Rx__["Subject"]();
        this.conversacion = {};
        this.estado = 0;
    ...
    ChatComponent.prototype.ngOnInit = function () {
        ...
        this.usuario = this.convService.usuario;
        this.scrollTrigger.subscribe(function () {
            _this.scrollDown(_this.forceScroll);
            _this.forceScroll = false;
        });
        this.route.params.subscribe(function (params) {
            _this.convService.getConversacion(params['conv_id'])
                .subscribe(function (data) {
                // this.blockContent.next(true);
                _this.blockui.stop('content');
                if (data.success) {
                    console.log(data);
                    _this.conversacion = data.result;
                    _this.estado = _this.conversacion.estado;
                    _this.convService.getMessages(_this.conversacion.chat_id)
    ...
    ChatComponent.prototype.atender = function () {
        var _this = this;
        if (this.conversacion) {
            this.convService.atenderSolicitud(this.conversacion)
                .subscribe(function (data) {
                if (data.success) {
                    _this.conversacion.estado = 2;
                    _this.estado = _this.conversacion.estado;
                }
            });
        }
    ...
    ChatComponent.prototype.ngOnDestroy = function () {
        // this.convService.chats = null;
    };
    ChatComponent.prototype.sendMessageEnter = function () {
        if (this.enterToSend) {
            if (this.message.trim() === '') {
                return;
            }
            this.convService.setMessage(this.message);
            this.message = '';
            this.forceScroll = true;
        }
    };
    ChatComponent.prototype.btnEnviar = function () {
        if (this.message.trim() === '') {
            return;
        }
        this.convService.setMessage(this.message);
    ...
    ChatComponent.prototype.scrollDown = function (force) {
        if (force === void 0) { force = false; }
        var elem = this.myScrollContainer.nativeElement;
        if (force || elem.scrollTop === elem.scrollHeight) {
            $(elem).animate({ scrollTop: elem.scrollHeight }, function () {
...
ChatComponent = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
        selector: 'atencion-pendiente',
        template: __webpack_require__("../../../../../src/app/+conversaciones/+chat/chat.component.html"),
        styles: [__webpack_require__("../../../../../src/app/+conversaciones/+chat/chat.component.css")]
    }),
    __metadata("design:paramtypes", [typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_1__angular_router__["a" /* ActivatedRoute */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__angular_router__["a" /* ActivatedRoute */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_2__shared_conversaciones_service__["a" /* ConversacionesService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__shared_conversaciones_service__["a" /* ConversacionesService */]) === "function" && _c || Object, typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_0__angular_core__["ElementRef"] !== "undefined" && __WEBPACK_IMPORTED_MODULE_0__angular_core__["ElementRef"]) === "function" && _d || Object, typeof (_e = typeof __WEBPACK_IMPORTED_MODULE_6_ng_block_ui__["BlockUIService"] !== "undefined" && __WEBPACK_IMPORTED_MODULE_6_ng_block_ui__["BlockUIService"]) === "function" && _e || Object])
], ChatComponent);
...
/***/ "../../../../../src/app/+conversaciones/+historial/historial.component.html":
/***/ (function(module, exports) {

module.exports = "<div id=\"content\">\n  <div class=\"row\">\n    <sa-big-breadcrumbs [items]=\"[' Historial de Atenciones']\" icon=\"wechat\"\n      class=\"col-xs-10 col-sm-7 col-md-7 col-lg-4\"></sa-big-breadcrumbs>\n  </div>  \n  \n  <sa-widgets-grid>\n    <div class=\"row\">\n      <article class=\"col-sm-12\">\n        <sa-widget color=\"darken\">\n          <div>\n            <div class=\"widget-body no-padding\">\n              <sa-datatable [options]=\"options\" [dtTrigger]=\"dtTrigger\" \n                [paginationLength]=\"true\" tableClass=\"table table-striped table-bordered table-hover\">\n                <thead>\n                  <tr>\n                    <!--th [style.width]=\"'4%'\"></th-->\n                    <th>\n                      <i class=\"fa fa-fw fa-user text-muted hidden-md hidden-sm hidden-xs\"></i>\n                      Cliente\n                    </th>\n                    <th>\n                      <i class=\"fa fa-fw fa-user text-muted hidden-md hidden-sm hidden-xs\"></i>\n                      Operador\n                    </th>\n                    <th [style.width]=\"'14%'\" data-hide=\"mobile-p\">\n                      <i class=\"fa fa-fw fa-clock-o text-muted hidden-md hidden-sm hidden-xs\"></i>\n                      Solicitada\n                    </th>\n                    <th [style.width]=\"'14%'\" data-hide=\"mobile-p\">\n                      <i class=\"fa fa-fw fa-clock-o text-muted hidden-md hidden-sm hidden-xs\"></i>\n                      Atendida\n                    </th>\n                    <th [style.width]=\"'14%'\" data-hide=\"mobile-p\">\n                      <i class=\"fa fa-fw fa-clock-o text-muted hidden-md hidden-sm hidden-xs\"></i>\n                      Finalizada\n                    </th>\n                    <!--th [style.width]=\"'8%'\" data-hide=\"mobile-p\">\n                      <i class=\"fa fa-fw fa-clock-o text-muted hidden-md hidden-sm hidden-xs\"></i>\n                      Duración\n                    </th-->\n                    <th [style.width]=\"'2%'\" data-hide=\"mobile-p\">Chat</th>\n                  </tr>\n                </thead>\n                <tbody *ngIf=\"itemsObs | async as items; else loading\">\n                  <ng-container *ngFor=\"let item of items; let last = last\" sa-cond-trigger [cond]=\"last ? true : false\" [trigger]=\"dtTrigger\">\n                    <tr>\n                      <td>{{ item.cliente.nombre }}</td>\n                      <td>{{ item.operador.nombre }}</td>\n                      <td [attr.data-order]=\"item.solicitada | moment:'x'\">{{ item.solicitada | date:\"dd-MM-yy HH:mm:ss a\" }}</td>\n                      <td [attr.data-order]=\"item.atendida | moment:'x'\">{{ item.atendida | date:\"dd-MM-yy HH:mm:ss a\" }}</td>\n                      <td [attr.data-order]=\"item.finalizada | moment:'x'\">{{ item.finalizada | date:\"dd-MM-yy HH:mm:ss a\" }}</td>\n                      <td class=\"text-center\">\n                        <a (click)=\"Chat(item)\">\n                          <i class=\"fa fa-lg fa-fw fa-wechat\"></i>\n                        </a>\n                      </td>\n                    </tr>\n                    <!--sa-dt-detalle [data]=\"item\" [type]=\"dcomp\" [trigger]=\"item._id\" [cols]=\"7\"></sa-dt-detalle-->\n                  </ng-container>\n                </tbody>\n                <ng-template #loading>\n                  <tr class=\"odd\">\n                    <td valign=\"top\" colspan=\"6\" class=\"dataTables_empty\">\n                      Cargando datos...\n                    </td>\n                  </tr>\n                </ng-template>\n              </sa-datatable>\n            </div>\n          </div>\n        </sa-widget>\n      </article>\n    </div>\n  </sa-widgets-grid>\n</div>\n"

/***/ }),

/***/ "../../../../../src/app/+conversaciones/+historial/historial.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return HistorialConversacionesComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/@angular/core.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_router__ = __webpack_require__("../../../router/@angular/router.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_rxjs_Rx__ = __webpack_require__("../../../../rxjs/Rx.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_rxjs_Rx___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_rxjs_Rx__);
...
var HistorialConversacionesComponent = (function () {
    function HistorialConversacionesComponent(router, convService) {
        this.router = router;
        this.convService = convService;
        this.itemsObs = new __WEBPACK_IMPORTED_MODULE_2_rxjs_Rx__["Subject"]();
        this.dtTrigger = new __WEBPACK_IMPORTED_MODULE_2_rxjs_Rx__["Subject"]();
    ...
    HistorialConversacionesComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.convService.getFinalizadas()
            .subscribe(function (data) {
            _this.itemsObs.next(data.result);
        });
    };
    HistorialConversacionesComponent.prototype.Chat = function (data) {
        this.router.navigate(['/conversaciones/chat', data._id]);
    };
    return HistorialConversacionesComponent;
}());
HistorialConversacionesComponent = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
        selector: 'historial-conversaciones',
        template: __webpack_require__("../../../../../src/app/+conversaciones/+historial/historial.component.html"),
        styles: []
    }),
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__angular_router__["c" /* Router */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__angular_router__["c" /* Router */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_5__shared_conversaciones_service__["a" /* ConversacionesService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_5__shared_conversaciones_service__["a" /* ConversacionesService */]) === "function" && _b || Object])
...
/***/ "../../../../../src/app/+conversaciones/+mis-conversaciones/detalle-conversacion.component.html":
/***/ (function(module, exports) {
...
/***/ "../../../../../src/app/+conversaciones/+mis-conversaciones/detalle-conversacion.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return DetalleConversacionComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/@angular/core.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_router__ = __webpack_require__("../../../router/@angular/router.es5.js");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
...
var DetalleConversacionComponent = (function () {
    function DetalleConversacionComponent(router) {
        this.router = router;
    }
    DetalleConversacionComponent.prototype.Detalle = function (data) {
        this.router.navigate(['detalle', data._id]);
    };
    DetalleConversacionComponent.prototype.Editar = function (data) {
        this.router.navigate(['editar', data._id]);
    };
    DetalleConversacionComponent.prototype.Desactivar = function (data) {
        this.router.navigate(['desactivar', data._id]);
    };
    return DetalleConversacionComponent;
}());
__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"])(),
    __metadata("design:type", Object)
], DetalleConversacionComponent.prototype, "data", void 0);
DetalleConversacionComponent = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
        template: __webpack_require__("../../../../../src/app/+conversaciones/+mis-conversaciones/detalle-conversacion.component.html")
    }),
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__angular_router__["c" /* Router */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__angular_router__["c" /* Router */]) === "function" && _a || Object])
], DetalleConversacionComponent);

var _a;
//# sourceMappingURL=detalle-conversacion.component.js.map

/***/ }),

/***/ "../../../../../src/app/+conversaciones/+mis-conversaciones/mis-conversaciones.component.html":
/***/ (function(module, exports) {

module.exports = "<div id=\"content\">\n  <div class=\"row\">\n    <sa-big-breadcrumbs [items]=\"[' Mis Conversaciones']\" icon=\"wechat\"\n      class=\"col-xs-10 col-sm-7 col-md-7 col-lg-4\"></sa-big-breadcrumbs>\n  </div>  \n  \n  <sa-widgets-grid>\n    <div class=\"row\">\n      <article class=\"col-sm-12\">\n        <sa-widget color=\"darken\">\n          <div>\n            <div class=\"widget-body no-padding\">\n              <sa-datatable [options]=\"options\" [dtTrigger]=\"dtTrigger\" \n                [paginationLength]=\"true\" tableClass=\"table table-striped table-bordered table-hover\">\n                <thead>\n                  <tr>\n                    <!--th [style.width]=\"'4%'\"></th-->\n                    <th>\n                      <i class=\"fa fa-fw fa-user text-muted hidden-md hidden-sm hidden-xs\"></i>\n                      Cliente\n                    </th>\n                    <th>\n                      <i class=\"fa fa-fw fa-user text-muted hidden-md hidden-sm hidden-xs\"></i>\n                      Operador\n                    </th>\n                    <th [style.width]=\"'14%'\" data-hide=\"mobile-p\">\n                      <i class=\"fa fa-fw fa-clock-o text-muted hidden-md hidden-sm hidden-xs\"></i>\n                      Solicitada\n                    </th>\n                    <th [style.width]=\"'14%'\" data-hide=\"mobile-p\">\n                      <i class=\"fa fa-fw fa-clock-o text-muted hidden-md hidden-sm hidden-xs\"></i>\n                      Atendida\n                    </th>\n                    <!--th [style.width]=\"'8%'\" data-hide=\"mobile-p\">\n                      <i class=\"fa fa-fw fa-clock-o text-muted hidden-md hidden-sm hidden-xs\"></i>\n                      Duración\n                    </th-->\n                    <th [style.width]=\"'2%'\" data-hide=\"mobile-p\">Chat</th>\n                  </tr>\n                </thead>\n                <tbody *ngIf=\"itemsObs | async as items; else loading\">\n                  <ng-container *ngFor=\"let item of items; let last = last\" sa-cond-trigger [cond]=\"last ? true : false\" [trigger]=\"dtTrigger\">\n                    <tr>\n                      <td>{{ item.cliente.nombre }}</td>\n                      <td>{{ item.operador.nombre }}</td>\n                      <td [attr.data-order]=\"item.solicitada | moment:'x'\">{{ item.solicitada | date:\"dd-MM-yy HH:mm:ss a\" }}</td>\n                      <td [attr.data-order]=\"item.atendida | moment:'x'\">{{ item.atendida | date:\"dd-MM-yy HH:mm:ss a\" }}</td>\n                      <td class=\"text-center\">\n                        <a (click)=\"Chat(item)\">\n                          <i class=\"fa fa-lg fa-fw fa-wechat\"></i>\n                        </a>\n                      </td>\n                    </tr>\n                    <!--sa-dt-detalle [data]=\"item\" [type]=\"dcomp\" [trigger]=\"item._id\" [cols]=\"7\"></sa-dt-detalle-->\n                  </ng-container>\n                </tbody>\n                <ng-template #loading>\n                  <tr class=\"odd\">\n                    <td valign=\"top\" colspan=\"5\" class=\"dataTables_empty\">\n                      Cargando datos...\n                    </td>\n                  </tr>\n                </ng-template>\n              </sa-datatable>\n            </div>\n          </div>\n        </sa-widget>\n      </article>\n    </div>\n  </sa-widgets-grid>\n</div>\n"

/***/ }),

/***/ "../../../../../src/app/+conversaciones/+mis-conversaciones/mis-conversaciones.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return MisConversacionesComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/@angular/core.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_router__ = __webpack_require__("../../../router/@angular/router.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_rxjs_Rx__ = __webpack_require__("../../../../rxjs/Rx.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_rxjs_Rx___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_rxjs_Rx__);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_rxjs_add_operator_catch___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4_rxjs_add_operator_catch__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__shared_conversaciones_service__ = __webpack_require__("../../../../../src/app/+conversaciones/shared/conversaciones.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__detalle_conversacion_component__ = __webpack_require__("../../../../../src/app/+conversaciones/+mis-conversaciones/detalle-conversacion.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var MisConversacionesComponent = (function () {
    function MisConversacionesComponent(router, convService) {
        this.router = router;
        this.convService = convService;
        this.itemsObs = new __WEBPACK_IMPORTED_MODULE_2_rxjs_Rx__["Subject"]();
        this.dtTrigger = new __WEBPACK_IMPORTED_MODULE_2_rxjs_Rx__["Subject"]();
        this.dcomp = __WEBPACK_IMPORTED_MODULE_6__detalle_conversacion_component__["a" /* DetalleConversacionComponent */];
        this.options = {
            dom: 'Bfrtip',
            columnDefs: [{
                    targets: [0, 4],
    ...
    MisConversacionesComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.convService.getActivas()
            .subscribe(function (data) {
            _this.itemsObs.next(data.result);
        });
    };
    MisConversacionesComponent.prototype.Chat = function (data) {
        this.router.navigate(['/conversaciones/chat', data._id]);
    };
    return MisConversacionesComponent;
}());
MisConversacionesComponent = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
        selector: 'mis-conversaciones',
        template: __webpack_require__("../../../../../src/app/+conversaciones/+mis-conversaciones/mis-conversaciones.component.html"),
        styles: []
    }),
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__angular_router__["c" /* Router */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__angular_router__["c" /* Router */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_5__shared_conversaciones_service__["a" /* ConversacionesService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_5__shared_conversaciones_service__["a" /* ConversacionesService */]) === "function" && _b || Object])
], MisConversacionesComponent);

var _a, _b;
//# sourceMappingURL=mis-conversaciones.component.js.map
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ConversacionesModule", function() { return ConversacionesModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/@angular/core.es5.js");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__conversaciones_routing__ = __webpack_require__("../../../../../src/app/+conversaciones/conversaciones.routing.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__atencion_pendiente_atencion_pendiente_component__ = __webpack_require__("../../../../../src/app/+conversaciones/+atencion-pendiente/atencion-pendiente.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__mis_conversaciones_mis_conversaciones_component__ = __webpack_require__("../../../../../src/app/+conversaciones/+mis-conversaciones/mis-conversaciones.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__historial_historial_component__ = __webpack_require__("../../../../../src/app/+conversaciones/+historial/historial.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__mis_conversaciones_detalle_conversacion_component__ = __webpack_require__("../../../../../src/app/+conversaciones/+mis-conversaciones/detalle-conversacion.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__chat_chat_component__ = __webpack_require__("../../../../../src/app/+conversaciones/+chat/chat.component.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__shared_conversaciones_service__ = __webpack_require__("../../../../../src/app/+conversaciones/shared/conversaciones.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__shared_keys_pipe__ = __webpack_require__("../../../../../src/app/+conversaciones/shared/keys.pipe.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var ConversacionesModule = (function () {
    function ConversacionesModule() {
    }
    return ConversacionesModule;
}());
ConversacionesModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
        declarations: [
            __WEBPACK_IMPORTED_MODULE_4__atencion_pendiente_atencion_pendiente_component__["a" /* AtencionPendienteComponent */],
            __WEBPACK_IMPORTED_MODULE_5__mis_conversaciones_mis_conversaciones_component__["a" /* MisConversacionesComponent */],
            __WEBPACK_IMPORTED_MODULE_6__historial_historial_component__["a" /* HistorialConversacionesComponent */],
            __WEBPACK_IMPORTED_MODULE_7__mis_conversaciones_detalle_conversacion_component__["a" /* DetalleConversacionComponent */],
            __WEBPACK_IMPORTED_MODULE_8__chat_chat_component__["a" /* ChatComponent */],
            __WEBPACK_IMPORTED_MODULE_12__shared_keys_pipe__["a" /* KeysPipe */]
        ],
        imports: [
            ...
            __WEBPACK_IMPORTED_MODULE_3__conversaciones_routing__["a" /* routing */],
        ...
        providers: [__WEBPACK_IMPORTED_MODULE_11__shared_conversaciones_service__["a" /* ConversacionesService */]]
    })
...
/***/ "../../../../../src/app/+conversaciones/conversaciones.routing.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__atencion_pendiente_atencion_pendiente_component__ = __webpack_require__("../../../../../src/app/+conversaciones/+atencion-pendiente/atencion-pendiente.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__mis_conversaciones_mis_conversaciones_component__ = __webpack_require__("../../../../../src/app/+conversaciones/+mis-conversaciones/mis-conversaciones.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__historial_historial_component__ = __webpack_require__("../../../../../src/app/+conversaciones/+historial/historial.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__chat_chat_component__ = __webpack_require__("../../../../../src/app/+conversaciones/+chat/chat.component.ts");
...
var routes = [
    {
        path: '',
        redirectTo: 'mis-conversaciones',
        pathMatch: 'full'
    },
    {
        path: 'atencion-pendiente',
        component: __WEBPACK_IMPORTED_MODULE_1__atencion_pendiente_atencion_pendiente_component__["a" /* AtencionPendienteComponent */],
        data: { pageTitle: 'Atencion Pendiente' }
    },
    {
        path: 'mis-conversaciones',
        component: __WEBPACK_IMPORTED_MODULE_2__mis_conversaciones_mis_conversaciones_component__["a" /* MisConversacionesComponent */],
        data: { pageTitle: 'Mis Conversaciones' }
    },
    {
        path: 'historial',
        component: __WEBPACK_IMPORTED_MODULE_3__historial_historial_component__["a" /* HistorialConversacionesComponent */],
...
//# sourceMappingURL=conversaciones.routing.js.map

/***/ }),

/***/ "../../../../../src/app/+conversaciones/shared/conversaciones.service.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ConversacionesService; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/@angular/core.es5.js");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_rxjs_add_operator_catch__ = __webpack_require__("../../../../rxjs/add/operator/catch.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_rxjs_add_operator_catch___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_5_rxjs_add_operator_catch__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__shared_auth_auth_service__ = __webpack_require__("../../../../../src/app/shared/auth/auth.service.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var ConversacionesService = (function () {
    function ConversacionesService(http, authService, db) {
        // this.itemsRef = db.list('roomchat');
        // this.roomchats = this.itemsRef.valueChanges();
        this.http = http;
        ...
        this.url = '/api/admin/conversaciones';
        // this.itemsRef = db.list('roomchat');
        // Use snapshotChanges().map() to store the key
        /*this.roomchats = this.itemsRef.snapshotChanges().map(changes => {
          return changes.map(c => ({ key: c.payload.key, ...c.payload.val() }));
        });*/
        this.usuario = this.authService.user;
    }
    ConversacionesService.prototype.getMessages = function (chat_id) {
        // if (!this.chatsRef) {
        this.chatsRef = this.db.list("/chat/" + chat_id + "/message");
        // }
        return this.chatsRef.valueChanges();
    };
    ConversacionesService.prototype.setMessage = function (message) {
        if (message.length > 0) {
            var messages = this.formatMessage(message);
            // console.log(messages);
            // console.log(this.chats);
            this.chatsRef.push(messages);
        }
    };
    ConversacionesService.prototype.formatMessage = function (message) {
        return {
            message: message,
    ...
    ConversacionesService.prototype.atenderSolicitud = function (conv) {
        return this.http
            .put(this.getUrl(conv._id, true), null, { headers: this.headers });
    };
    ConversacionesService.prototype.getConversacion = function (conv_id) {
        return this.http
            .get(this.getUrl(conv_id, true), { headers: this.headers });
    };
    ConversacionesService.prototype.getPendientes = function () {
        return this.http
            .get(this.getUrl('pendientes'), { headers: this.headers });
    };
    ConversacionesService.prototype.getActivas = function () {
        return this.http
            .get(this.getUrl('activas'), { headers: this.headers });
    };
    ConversacionesService.prototype.getFinalizadas = function () {
        return this.http
            .get(this.getUrl('finalizadas'), { headers: this.headers });
    };
    ConversacionesService.prototype.getUrl = function (id, detalle) {
        if (id === void 0) { id = null; }
        if (detalle === void 0) { detalle = false; }
        var urlParts = [this.url];
        if (detalle) {
            urlParts.push('detalle');
        }
        if (id) {
            urlParts.push(id);
        }
...
ConversacionesService = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Injectable"])(),
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__angular_common_http__["b" /* HttpClient */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__angular_common_http__["b" /* HttpClient */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_6__shared_auth_auth_service__["a" /* AuthService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_6__shared_auth_auth_service__["a" /* AuthService */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_2_angularfire2_database__["a" /* AngularFireDatabase */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2_angularfire2_database__["a" /* AngularFireDatabase */]) === "function" && _c || Object])
...
/***/ "../../../../../src/app/+conversaciones/shared/keys.pipe.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var app_1 = __webpack_require__("../../../../@firebase/app/dist/esm/index.js");
var Database_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/api/Database.js");
exports.Database = Database_1.Database;
var Query_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/api/Query.js");
exports.Query = Query_1.Query;
var Reference_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/api/Reference.js");
exports.Reference = Reference_1.Reference;
var util_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/util/util.js");
exports.enableLogging = util_1.enableLogging;
var RepoManager_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/RepoManager.js");
var INTERNAL = __webpack_require__("../../../../@firebase/database/dist/cjs/src/api/internal.js");
var TEST_ACCESS = __webpack_require__("../../../../@firebase/database/dist/cjs/src/api/test_access.js");
var util_2 = __webpack_require__("../../../../@firebase/util/dist/cjs/index.js");
...
var DataSnapshot_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/api/DataSnapshot.js");
exports.DataSnapshot = DataSnapshot_1.DataSnapshot;
var onDisconnect_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/api/onDisconnect.js");
 ...
 */
Object.defineProperty(exports, "__esModule", { value: true });
var util_1 = __webpack_require__("../../../../@firebase/util/dist/cjs/index.js");
var validation_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/util/validation.js");
var Path_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/util/Path.js");
var PriorityIndex_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/snap/indexes/PriorityIndex.js");
/**
...
Object.defineProperty(exports, "__esModule", { value: true });
var util_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/util/util.js");
var parser_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/util/libs/parser.js");
var Path_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/util/Path.js");
var Reference_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/api/Reference.js");
var Repo_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/Repo.js");
var RepoManager_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/RepoManager.js");
var util_2 = __webpack_require__("../../../../@firebase/util/dist/cjs/index.js");
var validation_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/util/validation.js");
/**
...
Object.defineProperty(exports, "__esModule", { value: true });
var util_1 = __webpack_require__("../../../../@firebase/util/dist/cjs/index.js");
var KeyIndex_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/snap/indexes/KeyIndex.js");
var PriorityIndex_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/snap/indexes/PriorityIndex.js");
var ValueIndex_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/snap/indexes/ValueIndex.js");
var PathIndex_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/snap/indexes/PathIndex.js");
var util_2 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/util/util.js");
var Path_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/util/Path.js");
var validation_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/util/validation.js");
var util_3 = __webpack_require__("../../../../@firebase/util/dist/cjs/index.js");
var EventRegistration_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/view/EventRegistration.js");
var util_4 = __webpack_require__("../../../../@firebase/util/dist/cjs/index.js");
...
Object.defineProperty(exports, "__esModule", { value: true });
var onDisconnect_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/api/onDisconnect.js");
var TransactionResult_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/api/TransactionResult.js");
var util_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/util/util.js");
var NextPushId_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/util/NextPushId.js");
var Query_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/api/Query.js");
var Repo_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/Repo.js");
var Path_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/util/Path.js");
var QueryParams_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/view/QueryParams.js");
var validation_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/util/validation.js");
var util_2 = __webpack_require__("../../../../@firebase/util/dist/cjs/index.js");
var util_3 = __webpack_require__("../../../../@firebase/util/dist/cjs/index.js");
var SyncPoint_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/SyncPoint.js");
 ...
 */
Object.defineProperty(exports, "__esModule", { value: true });
var WebSocketConnection_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/realtime/WebSocketConnection.js");
var BrowserPollConnection_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/realtime/BrowserPollConnection.js");
/**
 ...
 */
Object.defineProperty(exports, "__esModule", { value: true });
var RepoInfo_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/RepoInfo.js");
var PersistentConnection_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/PersistentConnection.js");
var RepoManager_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/RepoManager.js");
var Connection_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/realtime/Connection.js");
 ...
 */
Object.defineProperty(exports, "__esModule", { value: true });
var ImmutableTree_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/util/ImmutableTree.js");
var Path_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/util/Path.js");
var util_1 = __webpack_require__("../../../../@firebase/util/dist/cjs/index.js");
var Node_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/snap/Node.js");
var PriorityIndex_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/snap/indexes/PriorityIndex.js");
var util_2 = __webpack_require__("../../../../@firebase/util/dist/cjs/index.js");
/**
...
var util_2 = __webpack_require__("../../../../@firebase/util/dist/cjs/index.js");
var util_3 = __webpack_require__("../../../../@firebase/util/dist/cjs/index.js");
var util_4 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/util/util.js");
var Path_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/util/Path.js");
var VisibilityMonitor_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/util/VisibilityMonitor.js");
var OnlineMonitor_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/util/OnlineMonitor.js");
var util_5 = __webpack_require__("../../../../@firebase/util/dist/cjs/index.js");
var Connection_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/realtime/Connection.js");
var util_6 = __webpack_require__("../../../../@firebase/util/dist/cjs/index.js");
var util_7 = __webpack_require__("../../../../@firebase/util/dist/cjs/index.js");
var ServerActions_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/ServerActions.js");
 ...
 */
Object.defineProperty(exports, "__esModule", { value: true });
var ServerValues_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/util/ServerValues.js");
var nodeFromJSON_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/snap/nodeFromJSON.js");
var Path_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/util/Path.js");
var SparseSnapshotTree_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/SparseSnapshotTree.js");
var SyncTree_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/SyncTree.js");
var SnapshotHolder_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/SnapshotHolder.js");
var util_1 = __webpack_require__("../../../../@firebase/util/dist/cjs/index.js");
var util_2 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/util/util.js");
var util_3 = __webpack_require__("../../../../@firebase/util/dist/cjs/index.js");
var AuthTokenProvider_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/AuthTokenProvider.js");
var StatsManager_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/stats/StatsManager.js");
var StatsReporter_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/stats/StatsReporter.js");
var StatsListener_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/stats/StatsListener.js");
var EventQueue_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/view/EventQueue.js");
var PersistentConnection_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/PersistentConnection.js");
var ReadonlyRestClient_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/ReadonlyRestClient.js");
var Database_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/api/Database.js");
...
var util_1 = __webpack_require__("../../../../@firebase/util/dist/cjs/index.js");
var util_2 = __webpack_require__("../../../../@firebase/util/dist/cjs/index.js");
var storage_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/storage/storage.js");
var Constants_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/realtime/Constants.js");
/**
...
var parser_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/util/libs/parser.js");
var validation_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/util/validation.js");
__webpack_require__("../../../../@firebase/database/dist/cjs/src/core/Repo_transaction.js");
/** @const {string} */
...
var DataSnapshot_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/api/DataSnapshot.js");
var Path_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/util/Path.js");
var Tree_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/util/Tree.js");
var PriorityIndex_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/snap/indexes/PriorityIndex.js");
var util_2 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/util/util.js");
var ServerValues_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/util/ServerValues.js");
var validation_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/util/validation.js");
var util_3 = __webpack_require__("../../../../@firebase/util/dist/cjs/index.js");
var nodeFromJSON_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/snap/nodeFromJSON.js");
var ChildrenNode_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/snap/ChildrenNode.js");
var Repo_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/Repo.js");
...
var Path_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/util/Path.js");
var PriorityIndex_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/snap/indexes/PriorityIndex.js");
var CountedSet_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/util/CountedSet.js");
/**
 ...
 */
Object.defineProperty(exports, "__esModule", { value: true });
var CacheNode_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/view/CacheNode.js");
var ChildrenNode_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/snap/ChildrenNode.js");
var util_1 = __webpack_require__("../../../../@firebase/util/dist/cjs/index.js");
var util_2 = __webpack_require__("../../../../@firebase/util/dist/cjs/index.js");
var ViewCache_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/view/ViewCache.js");
var View_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/view/View.js");
var __referenceConstructor;
/**
...
var util_1 = __webpack_require__("../../../../@firebase/util/dist/cjs/index.js");
var util_2 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/util/util.js");
var AckUserWrite_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/operation/AckUserWrite.js");
var ChildrenNode_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/snap/ChildrenNode.js");
var util_3 = __webpack_require__("../../../../@firebase/util/dist/cjs/index.js");
var ImmutableTree_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/util/ImmutableTree.js");
var ListenComplete_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/operation/ListenComplete.js");
var Merge_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/operation/Merge.js");
var Operation_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/operation/Operation.js");
var Overwrite_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/operation/Overwrite.js");
var Path_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/util/Path.js");
var SyncPoint_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/SyncPoint.js");
var WriteTree_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/WriteTree.js");
/**
...
var util_2 = __webpack_require__("../../../../@firebase/util/dist/cjs/index.js");
var Path_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/util/Path.js");
var CompoundWrite_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/CompoundWrite.js");
var PriorityIndex_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/snap/indexes/PriorityIndex.js");
var ChildrenNode_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/snap/ChildrenNode.js");
/**
...
var util_1 = __webpack_require__("../../../../@firebase/util/dist/cjs/index.js");
var util_2 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/util/util.js");
var SortedMap_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/util/SortedMap.js");
var Node_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/snap/Node.js");
var snap_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/snap/snap.js");
var PriorityIndex_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/snap/indexes/PriorityIndex.js");
var KeyIndex_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/snap/indexes/KeyIndex.js");
var IndexMap_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/snap/IndexMap.js");
var LeafNode_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/snap/LeafNode.js");
var comparators_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/snap/comparators.js");
...
Object.defineProperty(exports, "__esModule", { value: true });
var util_1 = __webpack_require__("../../../../@firebase/util/dist/cjs/index.js");
var childSet_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/snap/childSet.js");
var util_2 = __webpack_require__("../../../../@firebase/util/dist/cjs/index.js");
var Node_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/snap/Node.js");
var PriorityIndex_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/snap/indexes/PriorityIndex.js");
var KeyIndex_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/snap/indexes/KeyIndex.js");
...
Object.defineProperty(exports, "__esModule", { value: true });
var SortedMap_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/util/SortedMap.js");
var SortedMap_2 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/util/SortedMap.js");
...
Object.defineProperty(exports, "__esModule", { value: true });
var Index_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/snap/indexes/Index.js");
var Node_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/snap/Node.js");
var util_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/util/util.js");
var util_2 = __webpack_require__("../../../../@firebase/util/dist/cjs/index.js");
var __EMPTY_NODE;
 ...
 */
Object.defineProperty(exports, "__esModule", { value: true });
var StatsCollection_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/stats/StatsCollection.js");
 ...
 */
Object.defineProperty(exports, "__esModule", { value: true });
var DOMStorageWrapper_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/storage/DOMStorageWrapper.js");
var MemoryStorage_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/storage/MemoryStorage.js");
/**
...
Object.defineProperty(exports, "__esModule", { value: true });
var util_1 = __webpack_require__("../../../../@firebase/util/dist/cjs/index.js");
var EventEmitter_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/util/EventEmitter.js");
var util_2 = __webpack_require__("../../../../@firebase/util/dist/cjs/index.js");
/**
...
Object.defineProperty(exports, "__esModule", { value: true });
var util_1 = __webpack_require__("../../../../@firebase/util/dist/cjs/index.js");
var Change_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/view/Change.js");
var util_2 = __webpack_require__("../../../../@firebase/util/dist/cjs/index.js");
/**
 * @constructor
 */
...
Object.defineProperty(exports, "__esModule", { value: true });
var DataSnapshot_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/api/DataSnapshot.js");
var Event_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/view/Event.js");
var util_1 = __webpack_require__("../../../../@firebase/util/dist/cjs/index.js");
var util_2 = __webpack_require__("../../../../@firebase/util/dist/cjs/index.js");
/**
...
var ValueIndex_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/snap/indexes/ValueIndex.js");
var PathIndex_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/snap/indexes/PathIndex.js");
var IndexedFilter_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/view/filter/IndexedFilter.js");
var LimitedFilter_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/view/filter/LimitedFilter.js");
var RangedFilter_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/view/filter/RangedFilter.js");
var util_3 = __webpack_require__("../../../../@firebase/util/dist/cjs/index.js");
/**
...
Object.defineProperty(exports, "__esModule", { value: true });
var IndexedFilter_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/view/filter/IndexedFilter.js");
var ViewProcessor_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/view/ViewProcessor.js");
var ChildrenNode_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/snap/ChildrenNode.js");
var CacheNode_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/view/CacheNode.js");
var ViewCache_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/view/ViewCache.js");
var EventGenerator_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/view/EventGenerator.js");
var util_1 = __webpack_require__("../../../../@firebase/util/dist/cjs/index.js");
var Operation_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/operation/Operation.js");
var Change_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/view/Change.js");
var PriorityIndex_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/snap/indexes/PriorityIndex.js");
...
var Operation_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/operation/Operation.js");
var util_1 = __webpack_require__("../../../../@firebase/util/dist/cjs/index.js");
var ChildChangeAccumulator_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/view/ChildChangeAccumulator.js");
var Change_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/view/Change.js");
var ChildrenNode_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/snap/ChildrenNode.js");
var KeyIndex_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/snap/indexes/KeyIndex.js");
var ImmutableTree_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/util/ImmutableTree.js");
var Path_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/util/Path.js");
var CompleteChildSource_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/view/CompleteChildSource.js");
/**
 * @constructor
 * @struct
 */
...
var CountedSet_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/util/CountedSet.js");
var StatsManager_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/stats/StatsManager.js");
var PacketReceiver_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/realtime/polling/PacketReceiver.js");
var Constants_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/realtime/Constants.js");
var util_2 = __webpack_require__("../../../../@firebase/util/dist/cjs/index.js");
var util_3 = __webpack_require__("../../../../@firebase/util/dist/cjs/index.js");
...
var storage_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/core/storage/storage.js");
var Constants_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/realtime/Constants.js");
var TransportManager_1 = __webpack_require__("../../../../@firebase/database/dist/cjs/src/realtime/TransportManager.js");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/@angular/core.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_firebase_database__ = __webpack_require__("../../../../firebase/database/index.js");
...
module.exports = __webpack_require__("../../../../@firebase/database/dist/cjs/index.js");
...
//# sourceMappingURL=conversaciones.module.chunk.js.map