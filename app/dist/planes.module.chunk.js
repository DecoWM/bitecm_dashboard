...
var InfocomercialComponent = (function () {
    ...
    InfocomercialComponent.prototype.saveInfoComercial = function () {
        ...
        if (this.formImagen.dirty || (formData.has('image_file') && this.imagenUrl.length)) {
            ...
            this.blockui.start('content');
            var plan_infocomercial_id_1 = $('#plan_id').val();
            this.planService.savePlanInfoComercial(plan_infocomercial_id_1, formData)
                .subscribe(function (data) {
                if (data.success) {
                    $('#fdescripcion' + plan_infocomercial_id_1).html(data.descripcion);
                    $('#finformacion_adicional' + plan_infocomercial_id_1).html(data.informacion_adicional);
                    $('#fflag_cantidad' + plan_infocomercial_id_1).html(data.flag_cantidad);
                    $('#fimagen_icons' + plan_infocomercial_id_1).attr('src', data.img_infocomercial);
    ...
    InfocomercialComponent.prototype.onValidationSuccess = function (e) {
        this.showModalInsertarInformacionComercial();
    };
    InfocomercialComponent.prototype.referenceValidator = function (formValidate) {
