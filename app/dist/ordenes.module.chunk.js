...
var DetalleOrdenComponent = (function () {
    ...
    DetalleOrdenComponent.prototype.ngOnInit = function () {
        ...
        this.route.params.subscribe(function (params) {
            ...
            _this.filter = _this.ordenesService.getFilter();
            _this.cursor = order_id; //this.ordenesService.getCursor();
            // determino la posicion del order_id actual
            _this.pos_cursor = _this.filter.indexOf(order_id);
            console.log('ordenes:' + _this.filter);
            // detectar las posiciones en base a la posicion del order_id
            _this.pos_prev = _this.pos_cursor - 1;
            _this.pos_next = _this.pos_cursor + 1;
            if (_this.pos_prev >= 0) {
                _this.prev = _this.filter[_this.pos_prev];
            }
            if (_this.pos_next <= _this.filter.length) {
                _this.next = _this.filter[_this.pos_next];
            }
            //this.prev = 1;
            console.log('prev:' + _this.prev);
            console.log('next:' + _this.next);
            _this.ordenesService.getOrden(order_id)
    ...
    DetalleOrdenComponent.prototype.orderBack = function () {
        this.router.navigate([this.prev], { relativeTo: this.route.parent });
    };
    DetalleOrdenComponent.prototype.orderNext = function () {
...
module.exports = "  <div id=\"content\">\r\n  <div class=\"row\">\r\n    <sa-big-breadcrumbs [items]=\"['Ordenes']\" icon=\"shopping-cart\"\r\n      class=\"col-xs-10 col-sm-7 col-md-7 col-lg-4\"></sa-big-breadcrumbs>\r\n  </div>\r\n\r\n  <ng-container *ngIf=\"alert\">\r\n    <alert *ngFor=\"let a of alert\" type=\"{{a.mode}}\" dismissible=\"true\">\r\n      <i class=\"fa-fw fa fa-{{a.icon}}\"></i>\r\n      <strong>{{a.title}}</strong> {{a.message}}\r\n    </alert>\r\n  </ng-container>\r\n  \r\n  <sa-widgets-grid>\r\n    \r\n    <div class=\"row\">\r\n      <article class=\"col-sm-12\">\r\n\r\n        <sa-widget class=\"well\" color=\"darken\">\r\n          <div>\r\n            <div class=\"widget-body no-padding\">\r\n              <mini-general-orders (onDateChanged)=\"filterByDateRange()\"></mini-general-orders>\r\n              <sa-datatable [options]=\"options\" [dtTrigger]=\"dtTrigger\" \r\n                [paginationLength]=\"true\" [filter]=\"true\" [dateRangeOptions]=\"dateRangeOptions\" (onInit)=\"initDtObj($event)\" (onPageSelected)=\"pageSelected($event)\" tableClass=\"table table-striped table-bordered table-hover\">\r\n                <thead>\r\n                  <tr>\r\n                    <th class=\"hasinput\" style=\"width:10%\">\r\n                      <input type=\"text\" class=\"form-control\" placeholder=\"Nro. Pedido\" (keyup)=\"getIdOrdens()\" (keypress)=\"getIdOrdens()\" (keydown)=\"getIdOrdens()\">\r\n                    </th>\r\n                    <th class=\"hasinput\" style=\"width:10%\">\r\n                      <input type=\"text\" class=\"form-control\" placeholder=\"Sede del Pedido\" (keyup)=\"getIdOrdens()\" (keypress)=\"getIdOrdens()\" (keydown)=\"getIdOrdens()\">\r\n                    </th>\r\n                    <th class=\"hasinput\" style=\"width:16%\">\r\n                      <input type=\"text\" class=\"form-control\" placeholder=\"Fecha\" (keyup)=\"getIdOrdens()\" (keypress)=\"getIdOrdens()\" (keydown)=\"getIdOrdens()\">\r\n                    </th>\r\n                    <th class=\"hasinput\" style=\"width:10%\">\r\n                      <input type=\"text\" class=\"form-control\" placeholder=\"Cliente / DNI\" (keyup)=\"getIdOrdens()\" (keypress)=\"getIdOrdens()\" (keydown)=\"getIdOrdens()\">\r\n                    </th>\r\n                    <th class=\"hasinput\" style=\"width:10%\">\r\n                      <input type=\"text\" class=\"form-control\" placeholder=\"Tipo de Linea\" (keyup)=\"getIdOrdens()\" (keypress)=\"getIdOrdens()\" (keydown)=\"getIdOrdens()\">\r\n                    </th>\r\n                    <th class=\"hasinput\" style=\"width:10%\">\r\n                      <input type=\"text\" class=\"form-control\" placeholder=\"Servicio\" (keyup)=\"getIdOrdens()\" (keypress)=\"getIdOrdens()\" (keydown)=\"getIdOrdens()\">\r\n                    </th>\r\n                    <th class=\"hasinput\" style=\"width:10%\">\r\n                      <input type=\"text\" class=\"form-control\" placeholder=\"Equipo\" (keyup)=\"getIdOrdens()\" (keypress)=\"getIdOrdens()\" (keydown)=\"getIdOrdens()\">\r\n                    </th>\r\n                    <th class=\"hasinput\" style=\"width:10%\">\r\n                      <input type=\"text\" class=\"form-control\" placeholder=\"Plan\" (keyup)=\"getIdOrdens()\" (keypress)=\"getIdOrdens()\" (keydown)=\"getIdOrdens()\">\r\n                    </th>\r\n                    <th class=\"hasinput\" style=\"width:12%\">\r\n                      <input type=\"text\" class=\"form-control\" placeholder=\"Estado\" (keyup)=\"getIdOrdens()\"  (keypress)=\"getIdOrdens()\" (keydown)=\"getIdOrdens()\">\r\n                    </th>\r\n                    <th class=\"hasinput\" style=\"width:10%\">\r\n                      <input type=\"text\" class=\"form-control\" placeholder=\"Total\" (keyup)=\"getIdOrdens()\" (keypress)=\"getIdOrdens()\" (keydown)=\"getIdOrdens()\">\r\n                    </th>\r\n                    <th class=\"hasinput\" style=\"width:12%\">\r\n                      <input type=\"text\" class=\"form-control\" placeholder=\"Evaluación\" (keyup)=\"getIdOrdens()\" (keypress)=\"getIdOrdens()\" (keydown)=\"getIdOrdens()\">\r\n                    </th>\r\n                  </tr>\r\n                  <tr>\r\n                    <th data-class=\"expand\" style=\"width:10%\">Nro. Pedido</th>\r\n                    <th data-hide=\"phone,tablet\" style=\"width:10%\">Sede del Pedido</th>\r\n                    <th data-hide=\"phone,tablet\" style=\"width:16%\">Fecha</th>\r\n                    <th data-hide=\"phone,tablet\" style=\"width:10%\">Cliente / DNI</th>\r\n                    <th data-hide=\"phone,tablet\" style=\"width:10%\">Tipo de Linea</th>\r\n                    <th data-hide=\"phone,tablet\" style=\"width:10%\">Servicio</th>\r\n                    <th data-hide=\"phone,tablet\" style=\"width:10%\">Equipo</th>\r\n                    <th data-hide=\"phone,tablet\" style=\"width:10%\">Plan</th>\r\n                    <!--<th data-hide=\"phone,tablet\">Sucursal</th>-->\r\n                    <th data-hide=\"phone,tablet\" style=\"width:12%\">Estado</th>\r\n                    <th data-hide=\"phone,tablet\" style=\"width:10%\">Total</th>\r\n                    <th data-hide=\"phone,tablet\" style=\"width:12%\">Evaluación</th>\r\n                  </tr>\r\n                </thead>\r\n                <tbody id=\"tableI\" *ngIf=\"itemsObs | async as items; else loading\">\r\n                  <ng-container *ngFor=\"let item of items; let last = last\" \r\n                    sa-cond-trigger [cond]=\"last ? true : false\" [trigger]=\"dtTrigger\">\r\n                    <tr>\r\n                      <td id=\"{{ item.order_id }}\" class=\"color-order-{{ item.colorfondo }}\">\r\n                        <a class=\"clic-icon\" (click)=\"detail(item)\"><span class=\"fa fa-eye\"></span> {{ item.order_id }}</a>\r\n                      </td>\r\n                      <td class=\"color-order-{{ item.order_repetida }}\">{{ item.branch_name }}</td>\r\n                      <td class=\"color-order-{{ item.order_repetida }}\" [attr.data-order]=\"item.created_at | moment:'x'\">{{ item.created_at }}</td>\r\n                      <td class=\"color-order-{{ item.order_repetida }}\">{{ item.id_number }}</td>\r\n                      <td class=\"color-order-{{ item.order_repetida }}\">{{ item.affiliation_type }}</td>\r\n                      <td class=\"color-order-{{ item.order_repetida }}\">{{ item.service_type }}</td>\r\n                      <td class=\"color-order-{{ item.order_repetida }}\" *ngIf=\"item.equipo_plan === 0\">{{ item.product_model }}</td>\r\n                      <td class=\"color-order-{{ item.order_repetida }}\" *ngIf=\"item.equipo_plan === 1\">SOLO PLAN</td>\r\n                      <td class=\"color-order-{{ item.order_repetida }}\">{{ item.plan_name }}</td>\r\n                      <!--<td>{{ item.branch_name }}</td>-->\r\n                      <td class=\"color-order-{{ item.order_repetida }}\">{{ item.order_status_name }}</td>\r\n                      <td class=\"color-order-{{ item.order_repetida }}\">{{ item.total_igv }}</td>\r\n                      <td class=\"color-order-{{ item.order_repetida }}\">{{ item.credit_status }}</td>\r\n                    </tr>\r\n                  </ng-container>                \r\n                </tbody>\r\n                <ng-template #loading>\r\n                  <tr class=\"odd\">\r\n                    <td valign=\"top\" colspan=\"11\" class=\"dataTables_empty\">\r\n                      {{ loadingStatus }}\r\n                    </td>\r\n                  </tr>\r\n                </ng-template>\r\n              </sa-datatable>\r\n\r\n            </div>\r\n          </div>\r\n        </sa-widget>\r\n      \r\n      </article>\r\n    </div>\r\n\r\n  </sa-widgets-grid>\r\n\r\n</div>"
...
var OrdenesComponent = (function () {
    ...
    OrdenesComponent.prototype.pageSelected = function (dtObj) {
        this.page = dtObj;
    ...
    OrdenesComponent.prototype.getIdOrdens = function () {
        var items = [];
        var columnValue;
...
var OrdenesService = (function () {
    ...
    OrdenesService.prototype.setFilter = function (filter) {
        this.filter = filter;
    };
    OrdenesService.prototype.getFilter = function () {
        return this.filter;
    };
    OrdenesService.prototype.setCursor = function (cursor) {
        this.cursor = cursor;
    };
    OrdenesService.prototype.getCursor = function () {
        return this.cursor;
    };
