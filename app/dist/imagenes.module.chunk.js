            ...
            if (this.bannermodel.stock_model_id) {
                ...
                this.sliderModelService.saveImage(type, formData)
                    ...
                    if (data.success) {
                        ...
                        _this.bannermodel.image_url = _this.bannermodel.image_url + '?v' + (new Date().getTime().toString());
        ...
        if (this.formHome.dirty || (formData.has('slider_images[]') && this.homeImageUrl.length)) {
            ...
            if (this.homemodel.stock_model_id) {
                ...
                this.sliderModelService.saveImage(type, formData)
                    ...
                    if (data.success) {
                        _this.homeImageUrl = [];
                        _this.homemodel.image_url = _this.homemodel.image_url + '?v' + (new Date().getTime().toString());
                        // this.sliderModelService.getImage(data.id)
                        //   .subscribe((smc: any) => {
                        //     if (smc.success) {
                        //       this.slidermodel = smc.result;
            ...
            if (this.slidermodel.stock_model_id) {
                ...
                this.sliderModelService.saveImage(type, formData)
                    ...
                    if (data.success) {
                        ...
                        _this.slidermodel.image_url = _this.slidermodel.image_url + '?v' + (new Date().getTime().toString());
                        // this.sliderModelService.getImage(data.id)
                        //   .subscribe((smc: any) => {
                        //     if (smc.success) {
                        //       this.slidermodel = smc.result;
